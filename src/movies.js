...
function howManyMovies(moviesArrayNum) {

    const bySpielberg = moviesArrayNum.filter (directed =>{

        if (directed.director == "Steven Spielberg" && directed.genre.includes("Drama")){
            return directed
